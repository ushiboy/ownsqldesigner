...
export default {
  ...
  exportMermaid: {
    ...
    codeTab: "コード",
    previewTab: "プレビュー",
    generatedCodeAriaLabel: "生成されたMermaidコード",
    noTablesMessage: "出力するテーブルがありません。",
    downloadMermaid: ".mmdをダウンロード",
    copyToClipboard: "クリップボードにコピー",
    copied: "コピーしました",
    previewLoadingMessage: "プレビューを生成しています…",
    previewErrorMessage: "プレビューを描画できませんでした。",
    previewImageAlt: "MermaidのER図プレビュー",
    close: "閉じる",
  },
  notificationBar: {
