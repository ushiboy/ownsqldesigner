...
export default {
  ...
  toolbar: {
    ...
    addTable: "Add Table",
    exportImportMenuLabel: "Export/Import",
  ...
  exportMermaid: {
    ...
    codeTab: "Code",
    previewTab: "Preview",
    generatedCodeAriaLabel: "Generated Mermaid code",
    noTablesMessage: "No tables to export.",
    downloadMermaid: "Download .mmd",
    copyToClipboard: "Copy to clipboard",
    copied: "Copied",
    previewLoadingMessage: "Rendering preview…",
    previewErrorMessage: "Couldn't render the preview.",
    previewImageAlt: "Mermaid ER diagram preview",
    close: "Close",
  },
  notificationBar: {
