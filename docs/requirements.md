...
| REQ-039 | PostgreSQL `DialectStrategy` (datatypes, identity-based auto-increment, reserved-keyword rejection, DDL generation), selectable when creating a schema ([0034](design/0034-postgresql-dialect-strategy.md), [0035](design/0035-dialect-selector-ui.md), [0036](design/0036-domain-layer-column-normalization.md)) | 3     |
