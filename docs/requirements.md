...
| ID      | Requirement                                                                                                                                                                                                                                                              | Phase |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----- |
| REQ-013 | Define PRIMARY KEY / UNIQUE / INDEX keys, including composite keys ([0007](design/0007-table-key-management.md), [0049](design/0049-key-row-label-title-tooltip.md))                                                                                                     | 1     |
