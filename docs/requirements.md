...
| REQ-004 | Multi-select (Shift+click / rubber-band) with group move ([0015](design/0015-multi-select-and-group-move.md), [0044](design/0044-side-panel-multiple-selection-count.md))                                  | 2     |
